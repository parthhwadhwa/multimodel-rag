    ...
    return (
        <header className="w-full py-12 flex flex-col items-center justify-center fade-in">
            <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 shadow-sm flex items-center justify-center">
            ...
            <p className="text-[14px] md:text-[15px] text-neutral-500 font-medium tracking-wide">
